...
class Contract(AppModel):
    ...
    conceled_at = models.DateField(blank=True, null=True, default=None)
    conceled_by = models.ForeignKey(to=User , on_delete=models.RESTRICT, blank=True , null=True , related_name="contract_conceled_by")